...
export async function POST() {
  ...
  const presetsObject = {
    common:
      "Keep it grounded or lightly stylized. Title should be related to theme. Backgrounds may include cozy cottages, campfires, village squares, wooden bridges, blue skies with clouds, or garden paths. Themes should feel soft, playful, or nostalgic. Effects minimal — perhaps some falling leaves or laundry in the breeze. Accessories simple. No grandiose titles (avoid 'king', 'emperor', etc). Abilities should be subtle and clever.",
...
Rarity: ${rarity}
Theme reference: ${randomlyUpdatedTheme}, Title should be related to theme.
Guidance:
